...
clean-Src:
	-$(RM) ./Src/GPIO_program.d ./Src/GPIO_program.o ./Src/GPIO_program.su ./Src/OSMCAL_program.d ./Src/OSMCAL_program.o ./Src/OSMCAL_program.su ./Src/RCC_prog.d ./Src/RCC_prog.o ./Src/RCC_prog.su ./Src/main.d ./Src/main.o ./Src/main.su ./Src/syscalls.d ./Src/syscalls.o ./Src/syscalls.su ./Src/sysmem.d ./Src/sysmem.o ./Src/sysmem.su
